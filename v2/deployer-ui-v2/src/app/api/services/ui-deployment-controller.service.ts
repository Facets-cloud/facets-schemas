...
class UiDeploymentControllerService extends __BaseService {
  ...
  /**
   * @param params The `UiDeploymentControllerService.CreateDeploymentUsingPOSTParams` containing the following parameters:
   *
   ...
   * @return OK
   */
  createDeploymentUsingPOSTResponse(params: UiDeploymentControllerService.CreateDeploymentUsingPOSTParams): __Observable<__StrictHttpResponse<DeploymentLog>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
  ...
  runAuroraDRRecipeUsingPOSTResponse(params: UiDeploymentControllerService.RunAuroraDRRecipeUsingPOSTParams): __Observable<__StrictHttpResponse<DeploymentLog>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/cc-ui/v1/clusters/${params.clusterId}/deployments/recipes/aurora/dr`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  runHotfixDeploymentRecipeUsingPOSTResponse(params: UiDeploymentControllerService.RunHotfixDeploymentRecipeUsingPOSTParams): __Observable<__StrictHttpResponse<DeploymentLog>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/cc-ui/v1/clusters/${params.clusterId}/deployments/recipes/deployment/hotfix`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  /**
   * @param params The `UiDeploymentControllerService.RunESDRRecipeUsingPOSTParams` containing the following parameters:
   *
   * - `deploymentRecipe`: deploymentRecipe
   *
   * - `clusterId`: clusterId
   ...
   * @return OK
   */
  runESDRRecipeUsingPOSTResponse(params: UiDeploymentControllerService.RunESDRRecipeUsingPOSTParams): __Observable<__StrictHttpResponse<DeploymentLog>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = params.deploymentRecipe;
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/cc-ui/v1/clusters/${params.clusterId}/deployments/recipes/es/dr`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return OK
   */
  runESDRRecipeUsingPOST(params: UiDeploymentControllerService.RunESDRRecipeUsingPOSTParams): __Observable<DeploymentLog> {
    return this.runESDRRecipeUsingPOSTResponse(params).pipe(
      __map(_r => _r.body as DeploymentLog)
    );
  }
  ...
  runMongoDRRecipeUsingPOSTResponse(params: UiDeploymentControllerService.RunMongoDRRecipeUsingPOSTParams): __Observable<__StrictHttpResponse<DeploymentLog>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/cc-ui/v1/clusters/${params.clusterId}/deployments/recipes/mongo/dr`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  runMongoResizeRecipeUsingPOSTResponse(params: UiDeploymentControllerService.RunMongoResizeRecipeUsingPOSTParams): __Observable<__StrictHttpResponse<DeploymentLog>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/cc-ui/v1/clusters/${params.clusterId}/deployments/recipes/mongo/resize`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  signOffDeploymentUsingPUTResponse(params: UiDeploymentControllerService.SignOffDeploymentUsingPUTParams): __Observable<__StrictHttpResponse<DeploymentLog>> {
    ...
    let req = new HttpRequest<any>(
      'PUT',
      this.rootUrl + `/cc-ui/v1/clusters/${params.clusterId}/deployments/${params.deploymentId}/signoff`,
      __body,
      {
        headers: __headers,
        params: __params,
...
module UiDeploymentControllerService {
  ...
  /**
   * Parameters for runESDRRecipeUsingPOST
   */
  export interface RunESDRRecipeUsingPOSTParams {

    /**
     * deploymentRecipe
     */
    deploymentRecipe: ESDRDeploymentRecipe;
