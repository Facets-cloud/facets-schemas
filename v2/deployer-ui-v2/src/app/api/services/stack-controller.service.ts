...
class StackControllerService extends __BaseService {
  ...
  getClusterTasksUsingGETResponse(stackName: string): __Observable<__StrictHttpResponse<Array<ClusterTask>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/cc/v1/stacks/clusterTask/${stackName}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  getSubstackUsingGETResponse(params: StackControllerService.GetSubstackUsingGETParams): __Observable<__StrictHttpResponse<Substack>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/cc/v1/stacks/substack/${params.substackName}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  updateStackUsingPUTResponse(params: StackControllerService.UpdateStackUsingPUTParams): __Observable<__StrictHttpResponse<Stack>> {
    ...
    let req = new HttpRequest<any>(
      'PUT',
      this.rootUrl + `/cc/v1/stacks/${params.stackName}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  toggleReleaseUsingPOSTResponse(params: StackControllerService.ToggleReleaseUsingPOSTParams): __Observable<__StrictHttpResponse<ToggleRelease>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/cc/v1/stacks/${params.stackName}/toggleRelease`,
      __body,
      {
        headers: __headers,
        params: __params,
