...
public class HelmServiceIntegrationTestK8s14 {
    ...
    private Logger logger = LoggerFactory.getLogger(HelmServiceIntegrationTestK8s14.class);
    ...
    private File getExecutable(String binaryName) {
        try {
            ...
            InputStream resourceAsStream = HelmServiceIntegrationTestK8s14.class.getResourceAsStream("/bin/"
                    + prefix + "/" + binaryName);
