...
-- start  Schema : points_awarded_bill_promotions
...
CREATE TABLE `points_awarded_bill_promotions` (
  ...
  UNIQUE KEY `program_id` (`org_id`,`program_id`,`customer_id`,`point_category_id`,`bill_id`,`promotion_id`,`awarded_date`) USING BTREE,
...
-- end  Schema : points_awarded_bill_promotions