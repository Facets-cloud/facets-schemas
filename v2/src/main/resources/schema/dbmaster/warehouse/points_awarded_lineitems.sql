...
-- start  Schema : points_awarded_lineitems
...
CREATE TABLE `points_awarded_lineitems` (
  ...
  UNIQUE KEY `program_id` (`org_id`,`program_id`,`customer_id`,`point_category_id`,`bill_lineitem_id`) USING BTREE,
...
-- end  Schema : points_awarded_lineitems