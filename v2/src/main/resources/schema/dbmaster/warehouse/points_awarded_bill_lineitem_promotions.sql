...
-- start  Schema : points_awarded_bill_lineitem_promotions
...
CREATE TABLE `points_awarded_bill_lineitem_promotions` (
  ...
  UNIQUE KEY `program_id` (`org_id`,`program_id`,`customer_id`,`point_category_id`,`bill_lineitem_id`,`promotion_id`) USING BTREE,
...
-- end  Schema : points_awarded_bill_lineitem_promotions