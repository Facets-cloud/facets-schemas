...
-- start  Schema : intouch_ke_api_logs_newtemp

CREATE TABLE `intouch_ke_api_logs_newtemp` (
...
) ENGINE=InnoDB AUTO_INCREMENT=117620641 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPRESSED;


-- end  Schema : intouch_ke_api_logs_newtemp