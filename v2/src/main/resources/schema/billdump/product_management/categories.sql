...
) ENGINE=InnoDB AUTO_INCREMENT=10460655 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=16 COMMENT='classification of products are mentioned in the table';
