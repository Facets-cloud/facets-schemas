...
-- start  Schema : membercare_requests
...
) ENGINE=InnoDB AUTO_INCREMENT=5381835 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=16;


-- end  Schema : membercare_requests