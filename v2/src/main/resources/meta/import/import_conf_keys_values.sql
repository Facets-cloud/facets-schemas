...
) ENGINE=InnoDB AUTO_INCREMENT=2079134 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=16 COMMENT='Table that stores the import config key values for each temp';
