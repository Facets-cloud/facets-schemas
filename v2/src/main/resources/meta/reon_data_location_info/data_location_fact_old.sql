...
-- start  Schema : data_location_fact_old

CREATE TABLE `data_location_fact_old` (
...
) ENGINE=InnoDB AUTO_INCREMENT=3051557 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


-- end  Schema : data_location_fact_old