...
public class MockCCDataBootstrap {
    ...
    private void init() {
        ...
        cluster.getClusterMetadata().put(ClusterMeta.TOOLS_URL, "crm-staging-new.cctools.capillarytech.com");
        cluster.getClusterMetadata().put(ClusterMeta.TOOLS_PASS, "dG9vbHN1c2VyOk5mV2FLTGlQWnQ=");
