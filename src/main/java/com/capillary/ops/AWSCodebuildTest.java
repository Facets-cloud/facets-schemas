...
public class AWSCodebuildTest {
    ...
    public static void test(CodeBuildClient codeBuildClient) throws Exception {
        ...
        codeBuildClient
                .listCuratedEnvironmentImages(ListCuratedEnvironmentImagesRequest.builder()
                    .build())
                .platforms()
                .stream()
    ...
    public static String getBuildSpec() throws Exception{
        InputStream buildSpecStream = AWSCodebuildTest.class.getClassLoader().getResourceAsStream("buildSpec.json");
