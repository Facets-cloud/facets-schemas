...
@Service
public class CodeBuildServiceDockerImpl extends CodeBuildServiceImpl {
  ...
  protected String createBuildSpec(CodeBuildApplication application) {
    ...
    cachePaths.add("/root/.docker-cache/*");
  ...
  // public CodeBuildApplication updateCodeBuildEnvironment()
