...
|---|---|---|---|---|---|
| ingress | aws_alb | 0.2 | <https://facets-cloud.github.io/facets-schemas/schemas/ingress/ingress.schema.json> | [Sample](schemas/ingress/ingress.aws_alb.sample.json) | [Readme](schemas/ingress/ingress.schema.md) |
...
| mysql | k8s | 0.1 | <https://facets-cloud.github.io/facets-schemas/schemas/mysql/mysql.schema.json> | [Sample](schemas/mysql/mysql.k8s.sample.json) | [Readme](schemas/mysql/mysql.schema.md) |
...
| mysql | aurora | 0.2 | <https://facets-cloud.github.io/facets-schemas/schemas/mysql/mysql.schema.json> | [Sample](schemas/mysql/mysql.aurora.sample.json) | [Readme](schemas/mysql/mysql.schema.md) |
| config_map | k8s | 0.2 | <https://facets-cloud.github.io/facets-schemas/schemas/config_map/config_map.schema.json> | [Sample](schemas/config_map/config_map.k8s.sample.json) | [Readme](schemas/config_map/config_map.schema.md) |
...
| redis | azure_cache | 0.1 | <https://facets-cloud.github.io/facets-schemas/schemas/redis/redis.schema.json> | [Sample](schemas/redis/redis.azure_cache.sample.json) | [Readme](schemas/redis/redis.schema.md) |
...
| service | k8s | 0.1 | <https://facets-cloud.github.io/facets-schemas/schemas/service/service.schema.json> | [Sample](schemas/service/service.k8s.sample.json) | [Readme](schemas/service/service.schema.md) |
...
| k8s_resource | k8s | 0.2 | <https://facets-cloud.github.io/facets-schemas/schemas/k8s_resource/k8s_resource.schema.json> | [Sample](schemas/k8s_resource/k8s_resource.k8s.sample.json) | [Readme](schemas/k8s_resource/k8s_resource.schema.md) |
